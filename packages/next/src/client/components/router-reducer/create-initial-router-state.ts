...
export function createInitialRouterState({
  ...
  const {
    ...
    lf: initialStaticFallbackStageByteLengthPromise,
  ...
  if (location !== null && metadataVaryPath !== null) {
    ...
    if (initialSeedData !== null && initialStaleTime !== undefined) {
      if (initialStaticFallbackStageByteLengthPromise !== undefined) {
        void (async () => {
          console.log(
            'fallback stage data (static) length:',
            await initialStaticFallbackStageByteLengthPromise
          )
        })()
      }
